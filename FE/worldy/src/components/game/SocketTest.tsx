...
export default function SocketTest() {
  ...
  function requestQuiz() {
    ...
    ws.send(
      "/pub/game/quiz/sundaykidz/2386a4ee-355f-4f1d-9b77-118b2cbf99f9/2",
      {},
      JSON.stringify(data)
    );
  }
    ...
    <>
      <div className="w-full h-full bg-white">
        ...
        <div className="flex flex-col">
          <button className="w-[120px] h-[50px] mt-[20px]" onClick={sendMsg}>
            소켓 데이터 전송
          </button>
          <button
            className="w-[120px] h-[50px] mt-[20px]"
